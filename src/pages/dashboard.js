...
import Accounting from './subpage/photo';
import Todos from './subpage/todos';
import Post from './subpage/post';
import Albums from './subpage/albums';
import Comments from './subpage/comments';
import Photos from './subpage/photo';
...
function Dashboard(props) {
  ...
  const click =[dashboard,album,comments,photos,post]
  const drawer = (
    <div>
      <Toolbar />
      <Divider />
      <List>
        {['Todos', 'Album', 'Comments', 'Photos','Post'].map((text, index) => (
